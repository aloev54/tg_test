...
def llm_style_post(title:str,text:str)->Optional[str]:
    ...
    sys_prompt=(
        ...
        "Требования: живой тон, 1–2 строки интро; затем 3–4 нумерованных блока с эмодзи 1️⃣ 2️⃣ 3️⃣ 4️⃣ "
        "(НЕ '-' и НЕ '•'); факты/цифры + щепотка эмоций/сравнений; "
        "выделяй <b>ключевое</b> и <i>детали</i> (4–8 курсивных фрагментов). "
        "Не вставляй ссылки и призывы. Верни ЧИСТЫЙ текст, разрешены только теги <b> и <i>. "
        "Общий размер ответа не должен превышать 1024 символа."
    )
    payload={
        "model":"gpt-4o-mini",
        "temperature":0.35,
